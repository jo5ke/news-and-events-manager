...
namespace Illuminate\Support\Facades {
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            ...
            /** @var \Manigo\Console\Kernel $instance */
    ...
    class Auth {
         ...
         *
         * @return \Manigo\Models\User|null
         * @static
         */
         ...
         *
         * @param mixed $id
         * @return \Manigo\Models\User|false
         * @static
         */
...
namespace Manigo\Services\Auth\TwoFactor {
    ...
    class Facade {
         ...
         *
         * @param \Manigo\Services\Auth\TwoFactor\TwoFactorAuthenticatable $user
         * @return bool
         * @static
         */
        public static function isEnabled($user)
        {
            /** @var \Manigo\Services\Auth\TwoFactor\Authy $instance */
         ...
         *
         * @param \Manigo\Services\Auth\TwoFactor\Contracts\Authenticatable $user
         * @return mixed
         * @static
         */
...
namespace Tymon\JWTAuth\Facades {
    ...
    class JWTAuth {
        ...
        public static function attempt($credentials)
        {
            ...
            /** @var \Manigo\Services\Auth\Api\JWTAuth $instance */
         ...
         *
         * @param bool $forceForever
         * @return \Manigo\Services\Auth\Api\JWTAuth
         * @static
         */
...
namespace  {
    ...
    class Authy extends \Manigo\Services\Auth\TwoFactor\Facade {}
